...
<body>
    <nav class="navbar">
        <div class="container">
            ...
            <a href="buku-home.php" class="back-button">
                ...
                <div class="col-md-8">
                    <div class="book-info">
                        ...
                        <div class="action-buttons">
                            <a href="#" onclick="showFeatureAlert()" class="btn-login">
                        ...
                        <div class="login-notice">
                                ...
                                Anda harus login terlebih dahulu untuk dapat meminjam buku ini dan Fitur peminjaman buku belum tersedia.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function showFeatureAlert() {
            alert("Anda harus login terlebih dahulu untuk dapat meminjam buku ini dan Fitur peminjaman buku belum tersedia!");
        }
