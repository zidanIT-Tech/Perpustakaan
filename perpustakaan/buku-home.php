...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="buku-home.php">
                                        ...
                                        <div class="book-card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="btn-group w-100">
                                                    <a href="lihat-buku-home.php?id=<?= $book['id_buku']; ?>" class="btn btn-view">
                                                        <i class="fas fa-eye me-1"></i> Lihat Detail
                                                    </a>
                                                </div>
                                                <div class="login-required" style="display: none;">
                                                    Login untuk melihat detail buku
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function showLoginRequired() {
            ...
            alert("Silakan login untuk melihat detail buku.");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (selectedCategory) {
                ...
                const targetCheckbox = document.querySelector(`input[value="${selectedCategory}"]`);
                if (targetCheckbox) {
