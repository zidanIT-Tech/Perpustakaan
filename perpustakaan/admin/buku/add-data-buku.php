    ...
    <div class="register-container">
        <div class="row g-0">
            ...
            <div class="col-md-6 left-section">
                ...
                <div class="welcome-text">TAMBAH BUKU</div>
            </div>
            ...
            <div class="col-md-6 right-section">
                <div class="form-container">
                    ...
                    <p class="form-subtitle">Tambahkan buku baru ke dalam perpustakaan</p>
                            ...
                            <div class="input-group">
                                <select class="form-control" id="id_rak" name="id_rak" required>
                                    ...
                                    <?php foreach ($rak as $r): ?>
                                        <option value="<?= $r['id_rak'] ?>">Rak <?= $r['no_rak'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <span class="input-group-text">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" id="deskripsi" name="deskripsi" 
                                          placeholder="Masukkan deskripsi buku" rows="4" required></textarea>
                                <span class="input-group-text">
