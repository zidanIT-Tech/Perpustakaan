        ...
        <div class="content w-100">
            <div class="container-fluid p-4">
                <div class="header" data-aos="fade-up">
                    <h1 class="fw-bold">Manajemen Kategori Buku</h1>
                ...
                <div class="custom-container" data-aos="fade-up" data-aos-delay="200">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <span class="total-count">Total Kategori: <?= $total_kategori ?></span>
                            <a href="add-data-kategori.php" class="btn btn-add">
                    ...
                    <div class="search-container">
                        ...
                        <input type="text" class="search-input" id="searchInput" placeholder="Cari kategori...">
                    </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($kategori_buku as $kategori): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $kategori['nama']; ?></td>
                                        <td><?= $kategori['dibuat_oleh']; ?></td>
                                        <td>
                                            <a href="edit-data-kategori.php?id=<?= $kategori['id_kategori']; ?>" 
                                               class="btn btn-action btn-edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="delete-data-kategori.php?id=<?= $kategori['id_kategori']; ?>" 
