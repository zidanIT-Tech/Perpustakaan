...
<head>
    ...
    <title>Ubah Data Petugas - Perpustakaan</title>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-6 right-section">
                <div class="form-container">
                    <h1 class="form-title">Ubah Data Petugas</h1>
                    <p class="form-subtitle">Silakan ubah data Petugas perpustakaan</p>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="../../landing/admin.php" class="text-primary text-decoration-none">
